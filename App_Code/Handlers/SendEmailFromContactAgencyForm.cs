...
/// <summary>
/// Сводное описание для SendEmailFromContactAgencyForm
/// </summary>
namespace REIQ.Handlers
{
    public class SendEmailFromContactAgencyForm : IHttpHandler, IRequiresSessionState
    {
        public SendEmailFromContactAgencyForm()
        {
            //
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            String agencyName = context.Request["agencyName"];
