<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContactAgency.ascx.cs" Inherits="usercontrols_ContactAgency" %>
...
<script type="text/javascript">
    ...
    function email() {
        ...
        if (checkResult) {
            ...
            if (sendEmailToAgency(txtName, txtPhone, txtEmail, txtComments, txtCode, agencyName, sendToEmail)) {
