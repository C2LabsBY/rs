<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DatePicker_narrow.ascx.cs" Inherits="usercontrols_DatePickerN" %>
...
<asp:TextBox runat="server" Width="69px" Style="color:#555555;" CssClass="DatePicker" ClientIDMode="AutoID" ID="DateTextBox" autocomplete="off" MaxLength="10"></asp:TextBox>
